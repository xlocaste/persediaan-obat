...
export default function Update({ auth, KelolaDataObatMasuk }) {
    const { data, setData, put, processing, errors } = useForm({
        id_penerimaan: KelolaDataObatMasuk.id_penerimaan || '',
        id_obat: KelolaDataObatMasuk.id_obat || '',
        id_distributor: KelolaDataObatMasuk.id_distributor || '',
        jumlah_masuk: KelolaDataObatMasuk.jumlah_masuk || '',
        tanggal_masuk: KelolaDataObatMasuk.tanggal_masuk || '',
        nama_distributor: KelolaDataObatMasuk.nama_distributor || '',
        petugas_penerima: KelolaDataObatMasuk.petugas_penerima || '',
        keterangan: KelolaDataObatMasuk.keterangan || '',
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('kelola-data-obat-masuk.update', KelolaDataObatMasuk.id));
    };

    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl leading-tight">Update Data Obat Masuk</h2>}>
            <Head title="Update Data Obat Masuk" />
